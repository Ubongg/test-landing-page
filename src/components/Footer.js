      ...
      <div className="footer">
        <div className="col-1">
          ...
          <div className="text-bx">
            <p>
              Vel voluptua disputationi in, mei in rebum iracundia, ad enim
              novum mei. Esse offendit vis ad, elitr option consectetuer duo te.
              Et pri visse voluptaria, eligendi opor te quo.{" "}
            </p>
          </div>
        </div>
        <div className="col-2">
